...
public class MiniPetAdapter extends RecyclerView.Adapter<MiniPetAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public MiniPetAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Gán View
    ...
    @Override
    public void onBindViewHolder(@NonNull MiniPetAdapter.ViewHolder holder, int position) {
        // Gán dữ liệu
